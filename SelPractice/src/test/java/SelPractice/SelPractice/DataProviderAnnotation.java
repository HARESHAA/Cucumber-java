...
WebDriver driver;
	...
	@DataProvider(name = "ip", indices = {0})// this makes sure only 1st data runs
	Object[][] inputData()
	{
		Object[][] data = {
							{"Meena", "meena@gmail.com", "9154984875"},
							{"Suresh", "suresh@gmail.com", "9154984865"},
							{"Sudhir", "sudhir@gmail.com", "9154984855"}
						  };
		return data;
		
	}
	
	@DataProvider(name = "ip1")
	Object[][] completedata()
	{
		Object[][] data2 = {
								{"Meena", "meena@gmail.com", "9154984875"},
